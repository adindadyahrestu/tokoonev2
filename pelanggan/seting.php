    ...
    <form method="post" enctype="multipart/form-data">
      ...
      <div class="form-group row">
            ...
            <div class="col-sm-9">
                ...
                <a href="index.php?page=ubah_password" class="btn btn-sm btn-primary mt-3">Ubah Password</a>
            </div>
      </div>
      ...
      <div class="form-group row">
            ...
            <div class="col-sm-9">
                <img src="../assets/foto_pelanggan/<?php echo $pecah['foto_pelanggan'];?>" width="100">
